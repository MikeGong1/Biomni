...
| Fork unique-change screening | 694 | 200 | 0 | batches 001–008 complete | PARTIAL |
...
|---|---:|---:|---:|---|---|
| Code-visible people | 105 user logins + 1 bot; 56 raw tuples unresolved | 105 user logins + 1 bot; 56 tuples preserved | 0 | contributor/history/PR authors complete; fork screening partial | PARTIAL |
...
The 105 public user logins are the canonical union of public organization members,
contributors, and all 182 open/merged/closed-unmerged PR authors. One contributor/
PR bot is stored but excluded from the human count; twenty-two substantive unique fork
