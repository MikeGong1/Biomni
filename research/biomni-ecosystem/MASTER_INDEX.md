...
| Structured database | database | ACTIVE | Stable IDs and canonical evidence records | `database/` | `repo-000001`–`repo-000092`, `person-github-000001`–`person-github-000046`, `evidence-000001`–`evidence-000034` |
...
| Main commits, batch 001 | commit inventory | PARTIAL | Newest 100 of 487 commits; page 2 pending | `upstream/commits/batch-001.md` | `evidence-000015` |
...
| Public forks, batch 003 | fork inventory | PARTIAL | Forks 201–300 of 690, newest first; page 4 pending | `upstream/forks/batch-003.md` | `evidence-000032` |
| Public forks, batch 004 | fork inventory | PARTIAL | Forks 301–400 of 690, newest first; page 5 pending | `upstream/forks/batch-004.md` | `evidence-000033` |
| Main commits, batch 003 | commit inventory | PARTIAL | Commits 201–300 of 487; page 4 pending | `upstream/commits/batch-003.md` | `evidence-000034` |
