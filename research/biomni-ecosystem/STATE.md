...
pending_units:
- screen remaining 669 observed fork identities for substantive unique changes
...
next_action: screen next bounded fork batch, prioritizing tree-only and active repositories
